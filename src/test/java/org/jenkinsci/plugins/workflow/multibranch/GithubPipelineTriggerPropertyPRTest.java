...
public class GithubPipelineTriggerPropertyPRTest {

    @Rule
    public JenkinsRule jenkins = new JenkinsRule();
    private final List<String> branchNames = Arrays.asList("master");
    private final List<String> prNames = Arrays.asList("PR-1");
    ...
    private final String repository = "https://github.com/aytuncbeken/multibranch-action-triggers-test.git";
    ...
    public GithubPipelineTriggerPropertyPRTest(String branchIncludeFilter, String branchExcludeFilter) {
    ...
    private WorkflowMultiBranchProject createWorkflowMultiBranchJobWithTriggers(
        ...
        GitHubSCMSource gitHubSCMSource = new GitHubSCMSource("", "", this.repository, true);
